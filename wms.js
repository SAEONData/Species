...
function loadWMS(map, baseURL, customParams, opacity, version){
    var tileHeight = 256;
    var tileWidth = 256;
    var opacityLevel = opacity != null ? opacity : 0.75;
    var layerversion = version;
    var isPng = true;
    var minZoomLevel = 2;
    var maxZoomLevel = 28;
    ...
    var overlayOptions =
    {
        getTileUrl: function(coord, zoom)
        {
            ...
            return "http://maps.mapable.co.za/mapdn/tilecache.aspx?tile=" + escape(urlResult);
        },
