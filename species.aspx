<%@ Page Title="" Language="C#" MasterPageFile="~/Species.Master" AutoEventWireup="true" CodeBehind="species.aspx.cs" Inherits="species.species" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        global.onLoadView = function (id) {
            currentSpecies = id;
            $('#speciesMediaTab').load('speciesmedia.aspx?id=' + id + '&mode=view', function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul id="myTab" class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#specgen" id="specgen-tab" role="tab" data-toggle="tab" aria-controls="specgen" aria-expanded="false">General</a></li>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane active fade in" id="specgen" aria-labelledby="specgen-tab">
                            <br />
                            <strong>Taxonomy</strong><br />
                            <div id="vffTaxonomyID"></div>
                            <br />
    ...
    <div id="editDialogTblSpecies" class="modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="editDialogTitleTblSpecies">Edit Species</h4>
                </div>
                <div class="modal-body">
                    <ul id="editTabs" class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#edit-references" role="tab" id="edit-references-tab" data-toggle="tab" aria-controls="edit-references" aria-expanded="false">More</a></li>
                    </ul>
                    ...
                    <div id="Div1" class="tab-content">
                        <div role="tabpanel" class="tab-pane active fade in" id="edit-general" aria-labelledby="edit-general-tab">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Search" id="effTaxonomyID">
                                <div class="input-group-btn">
                                    <button class="btn btn-default taxonButton" id="ebfTaxonomyID" type="submit"><i class="glyphicon glyphicon-search"></i></button>
                                </div>
                            </div>
                            </form>
                            <br />
                            <strong>Common Name</strong><br />
                            <input class="form-control" type="text" id="effCommonName"><br />
                            <strong>Species Name</strong><br />
                            <input class="form-control" type="text" id="effSpeciesName"><br />
                            <strong>Fish board name</strong><br />
                            <input class="form-control" type="text" id="effFishBoard"><br />
                           
                            <strong>Features</strong><br />
                            <input class="form-control" type="text" id="effFeatures"><br />
                            <strong>Colour</strong><br />
                            <input class="form-control" type="text" id="effColour"><br />
                            <strong>Size</strong><br />
                            <input class="form-control" type="text" id="effSize"><br />
                            <strong>Distribution</strong><br />
                            <textarea class="form-control" id="effDistribution" rows="3"></textarea><br />
                        </div>

                        <div role="tabpanel" class="tab-pane" id="edit-references" aria-labelledby="edit-references-tab">
                            <br />
                            <strong>References</strong><br />
                            <textarea class="form-control" id="effReferences" rows="4"></textarea><br />
                            <strong>Similar</strong><br />
                            <textarea class="form-control" id="effSimilar" rows="4"></textarea><br />
                            <strong>Notes</strong><br />
                            <input class="form-control" type="text" id="effNotes"><br />
                ...
                <div class="modal-footer">
                    <button id="buttonSave" type="button" target="TblSpecies" class="btn btn-default">Save</button>
